...
export default function TimetablePage() {
  ...
  const handleSave = () => {
    ...
    if (editId) {
      ...
      // Remove existing period for same slot
                          ...
                          <div className="rounded bg-primary/10 border border-primary/20 p-1.5 group">
                            ...
                            <div className="flex gap-1 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button
                                ...
                                data-ocid="timetable.edit_button"
                              >
        ...
        <DialogContent data-ocid="timetable.dialog">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button onClick={handleSave} data-ocid="timetable.save_button">
                {editId ? "Update" : "Add"}
              </Button>
            </div>
          </div>
