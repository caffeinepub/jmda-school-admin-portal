  ...
  return (
    <div className="p-4 lg:p-6 space-y-4">
      ...
      <Tabs defaultValue="take">
        <TabsList>
          <TabsTrigger value="take" data-ocid="attendance.tab">
            Take Attendance
          </TabsTrigger>
        ...
        <TabsContent value="take" className="space-y-4 mt-4">
                    ...
                    {studentsInClass.map((s, idx) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <RadioGroup
                            value={
                              currentAttendance[s.id.toString()] ?? "present"
                            }
                            onValueChange={(v) =>
                              setStudentStatus(
                                s.id.toString(),
                              ...
                              (status) => (
                                ...
                                >
                                  <RadioGroupItem
                                    value={status}
                                    id={`${s.id}-${status}`}
                                    data-ocid={`attendance.radio.${idx + 1}`}
                                  />
                                  <Label
                                    htmlFor={`${s.id}-${status}`}
