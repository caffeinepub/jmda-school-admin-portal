...
export default function ReportsStudentInfoPage() {
    ...
    <div className="p-4 lg:p-6 space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Detailed student information report
          </p>
        </div>
        <Button
          variant="outline"
          ...
          data-ocid="reports-student-info.primary_button"
        >
      ...
      <div className="max-w-xs no-print">
        ...
        <Select value={classFilter} onValueChange={setClassFilter}>
          <SelectTrigger data-ocid="reports-student-info.select">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      {filteredStudents.length === 0 ? (
        <div
          ...
          data-ocid="reports-student-info.empty_state"
        >
          No students found.
        </div>
      ) : (
            ...
            <TableBody>
              {filteredStudents.map((s, idx) => {
                ...
                return (
                  <TableRow
                    key={s.id.toString()}
                    data-ocid={`reports-student-info.row.${idx + 1}`}
                  >
