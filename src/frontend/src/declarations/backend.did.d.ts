...
export interface _SERVICE {
  ...
  'getMyClass' : ActorMethod<[], [] | [ClassView]>,
  'getMyStudents' : ActorMethod<[], Array<Student>>,
  'getMyTeacherId' : ActorMethod<[], [] | [TeacherId]>,
  'getSchoolStats' : ActorMethod<[], SchoolStats>,
  'getStudent' : ActorMethod<[StudentId], [] | [Student]>,
  'getTeacher' : ActorMethod<[TeacherId], [] | [Teacher]>,
  'getTeacherByPrincipal' : ActorMethod<[Principal], [] | [Teacher]>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'linkTeacherLogin' : ActorMethod<[Principal, bigint], undefined>,
